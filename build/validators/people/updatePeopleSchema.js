...
exports.updatePeopleSchema = exports.reportVotePeople = exports.idUpdatePeople = void 0;
var _joi = _interopRequireDefault(require("joi"));
function _interopRequireDefault(e) { return e && e.__esModule ? e : { "default": e }; }
var updatePeopleSchema = exports.updatePeopleSchema = _joi["default"].object({
...
var idUpdatePeople = exports.idUpdatePeople = _joi["default"].object({
  id: _joi["default"].number().required().min(1)
}).messages({
  'number.base': 'El campo {#label} debe ser un número.',
  'any.required': '{ #label } es obligatorio'
});
var reportVotePeople = exports.reportVotePeople = _joi["default"].object({
  isVoted: _joi["default"]["boolean"]().required()
}).messages({
