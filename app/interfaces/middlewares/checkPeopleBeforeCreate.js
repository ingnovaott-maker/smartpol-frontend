...
const ERROR_MESSAGES = {
    ...
    REGISTERED_WITH_LEADER_AND_CANDIDATE: "El usuario ya fue registrado. Lider: {leaderName}, Candidato: {candidate}",
    REGISTERED_WITH_LEADER: "El usuario ya fue registrado. Lider: {leaderName}, sin candidato",
    REGISTERED_WITH_CANDIDATE: "El usuario ya fue registrado sin lider. Candidato: {candidate}",
};
const checkPeopleBeforeCreate = async (req, res, next) => {
    const  identification  = req.body?.identificationNumber;
...
export { checkPeopleBeforeCreate }